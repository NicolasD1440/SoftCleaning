...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <div class="wow fadeIn">
        ...
        <h1>Una innovación limpia</h1>
        <h2>Prevenimos <span class="rotating">el desperdicio de materiales reutilizables, la contaminacion, el calentamiento global</span></h2>
        <div class="actions">
          <a href="#about" class="btn-get-started">iniciemos el recorrido</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#about">Vigilancia</a></li>
  ...
  ============================-->
  <section id="about">
    <div class="container wow fedeInUp">
        <div class="row">
            <div class="col-md-12">   
                <h3 class="section-title">Sensores del modulo de vigilancia</h3>
                <div class="section-tittle-divider"></div>
            </div>
        </div>
    </div>
      <div class="container abaut-container wow fateInUp">
          <div class="row">
              <div class="col-md-12 col-md-12 about-content">
                <br>
